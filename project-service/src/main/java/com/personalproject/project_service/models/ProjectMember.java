...
public class ProjectMember extends BaseEntity {
    ...
    public ProjectMember(LocalDateTime createdAt, LocalDateTime updatedAt, Boolean deleted, ProjectMemberId id,
                         Project project, String description, Role role, String specificRole) {
