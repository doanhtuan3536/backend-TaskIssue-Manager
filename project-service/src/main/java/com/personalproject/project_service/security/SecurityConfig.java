package com.personalproject.project_service.security;

import com.personalproject.project_service.security.jwt.JwtTokenFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                        auth -> auth.requestMatchers(HttpMethod.POST, "/api/v1/users/login").permitAll()
                                .requestMatchers(HttpMethod.POST, "/api/v1/users/service/login").permitAll()
